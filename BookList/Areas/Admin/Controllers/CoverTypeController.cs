...
namespace BookList.Areas.Admin.Controllers
{
    ...
    public class CoverTypeController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            parameter.Add("@Id", id);
            coverType = _unitOfWork.SP_Call.OneRecord<CoverType>(StaticDetail.Proc_CoverType_Get, parameter);
            if (coverType == null)
            {
                return NotFound();
            }
        ...
        {
            var allObj = _unitOfWork.SP_Call.List<CoverType>(StaticDetail.Proc_CoverType_GetAll, null);
        ...
        public IActionResult Delete(int id)
        {
            var parameter = new DynamicParameters();
            parameter.Add("@Id", id);
            var objFromDb = _unitOfWork.SP_Call.OneRecord<CoverType>(StaticDetail.Proc_CoverType_Get, parameter);
            if (objFromDb == null)
            {
